...
class RestaurantForm(forms.ModelForm):
    ...
    genre = forms.ChoiceField(choices=GENRE_CHOICES, required=False, label='ジャンル (任意)')
    PRICE_RANGE_CHOICES = [
        ('0-999円', '～￥999'),
    ...
    location = forms.CharField(required=False, label='場所 (任意)')
    url = forms.URLField(required=False, label='ウェブサイトURL (任意)')  
