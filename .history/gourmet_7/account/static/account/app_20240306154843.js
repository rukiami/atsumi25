    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        select: function (info) {
            ...
            if (eventName) {
                ...
                axios.post('/account/add_event/', {
                    ...
                    start_date: Math.round(info.start.valueOf() / 1000), // UTCのタイムスタンプに変換
                    // end_date: info.end.valueOf(), // UTCのタイムスタンプに変換
                    end_date: Math.round(info.end.valueOf() / 1000),
                })
        ...
        events: function (info, successCallback, failureCallback) {
            axios.post('/account/get_events/', {
                start_date: Math.round(info.start.valueOf() / 1000), // UTCのタイムスタンプに変換
                end_date: Math.round(info.end.valueOf() / 1000), // UTCのタイムスタンプに変換
